...
class NativeClass(object):
    ...
    def _is_ref_class(self, depth = 0):
        """
        Mark the class as 'ryse2d::Ref' or its subclass.
        """
...
class Generator(object):
    ...
    def is_ryse_class(self, namespace_class_name):
        script_ns_dict = self.config['conversions']['ns_map']
        for (k, v) in script_ns_dict.items():
            if namespace_class_name.find("std::") == 0:
                return False
    ...
    def scriptname_ryse_class(self, namespace_class_name):
        script_ns_dict = self.config['conversions']['ns_map']
        for (k, v) in script_ns_dict.items():
            if namespace_class_name.find(k) >= 0:
                return namespace_class_name.replace("*","").replace("const ", "").replace(k,v)
    ...
    def js_typename_from_natve(self, namespace_class_name):
        ...
        for (k, v) in script_ns_dict.items():
            if namespace_class_name.find(k) >= 0:
                if namespace_class_name.find("ryse2d::Vec2") == 0:
                    return "vec2_object"
                if namespace_class_name.find("ryse2d::Vec3") == 0:
                    return "vec3_object"
                if namespace_class_name.find("ryse2d::Vec4") == 0:
                    return "vec4_object"
                if namespace_class_name.find("ryse2d::Mat4") == 0:
                    return "mat4_object"
                if namespace_class_name.find("ryse2d::Vector") == 0:
                    return "Array"
                if namespace_class_name.find("ryse2d::Map") == 0:
                    return "map_object"
                if namespace_class_name.find("ryse2d::Point")  == 0:
                    return "point_object"
                if namespace_class_name.find("ryse2d::Size")  == 0:
                    return "size_object"
                if namespace_class_name.find("ryse2d::Rect")  == 0:
                    return "rect_object"
                if namespace_class_name.find("ryse2d::Color3B") == 0:
                    return "color3b_object"
                if namespace_class_name.find("ryse2d::Color4B") == 0:
                    return "color4b_object"
                if namespace_class_name.find("ryse2d::Color4F") == 0:
    ...
    def js_ret_name_from_native(self, namespace_class_name, is_enum) :
        if self.is_ryse_class(namespace_class_name):
            if namespace_class_name.find("ryse2d::Vector") >=0:
                return "new Array()"
            if namespace_class_name.find("ryse2d::Map") >=0:
                return "map_object"
            if is_enum:
                ...
                return self.scriptname_ryse_class(namespace_class_name)
    ...
    for t in targets:
        ...
        for s in sections:
            ...
            gen_opts = {
                ...
                'outdir': outdir,
                'search_path': os.path.abspath(os.path.join(userconfig.get('DEFAULT', 'rysedir'), 'ryse')),

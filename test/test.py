...
def main():
    ...
    ryse_root = os.path.abspath(project_root)
    jsb_root = os.path.abspath(os.path.join(project_root, 'ryse/scripting/js-bindings'))
    ...
    config.set('DEFAULT', 'rysedir', ryse_root)
